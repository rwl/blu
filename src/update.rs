...
/// [`solve_for_update()`](crate::solve_for_update()) to provide the column
...
/// to [`solve_for_update()`](crate::solve_for_update()) in which the forward
/// system was solved.
///
/// The index of the column to be replaced is defined by the unit vector in the
/// last call to [`solve_for_update()`](crate::solve_for_update()) in which the
/// transposed system was solved.
///
/// ## Arguments
///
...
///   [`solve_for_update()`](crate::solve_for_update()), where `j0` is the column
///   to be replaced;
/// - the dot product of the incoming column and the solution to the transposed
///   system computed by [`solve_for_update()`](crate::solve_for_update()).
///
...
/// ## Returns
///
/// [`Status::ErrorInvalidCall`] if the factorization is invalid or the update was not
/// prepared by two calls to [`solve_for_update()`](crate::solve_for_update()).
///
/// [`Status::Reallocate`] for insufficient memory in `w_i`,`w_x`. The number of additional
